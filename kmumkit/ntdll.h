...
#define DECLARE_STATIC_UNICODE_STRING_SIZE(_var, _size) \
    WCHAR _var##_buffer[_size];                         \
    __pragma(warning(push))                             \
        __pragma(warning(disable : 4221)) __pragma(warning(disable : 4204)) static UNICODE_STRING _var = {0, (_size) * sizeof(WCHAR), _var##_buffer} __pragma(warning(pop))
...
#define TOKEN_SECURITY_ATTRIBUTES_INFORMATION_VERSION    TOKEN_SECURITY_ATTRIBUTES_INFORMATION_VERSION_V1
    ...
    NtShutdownWorkerFactory(
        _In_ HANDLE            WorkerFactoryHandle,
        volatile _Inout_ LONG* PendingWorkerCount);
